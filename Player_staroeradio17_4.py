...
class StaroeRadioPlayer:
    ...
    def setup_ui(self):
        ...
        paned_window.add(left_paned, width=400)
        ...
        # ttk.Button(search_frame, text="📋 Вставить", command=self.paste).pack(side=tk.LEFT, padx=(0, 3))
        ...
        info_fg = info_colors.get("foreground", "#C8C8C8")
    ...
    def _bind_results_context_menu(self, widget):
        ...
        def show_menu(event):
            ...
            if 0 <= line_num < len(self.current_results):
                ...
                menu.add_command(label=label, command=lambda: self._download_mp3([track]))
                menu.add_separator()
